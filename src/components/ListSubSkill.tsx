...
type Row = { id: number; nome: string; efeito?: string | null; qualidade: string };
...
export default function SubSkillsGrid({ rows }: Props) {
  const columns: GridColDef<Row>[] = [
    { field: "nome", headerName: "Sub Skill", flex: 1, maxWidth:200, minWidth: 160 },
    {
      field: "efeito",
      headerName: "Efeito",
      flex: 2,
